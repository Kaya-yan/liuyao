  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full transition-all duration-[3000ms] ease-out ${
            phase >= 1 ? 'bg-gold/[0.03] scale-100' : 'bg-gold/0 scale-0'
          }`}
          style={{ filter: 'blur(80px)' }}
        />
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full transition-all duration-[2000ms] ease-out delay-500 ${
      ...
      <div className="relative mb-10">
        {/* 光晕 */}
        <div
          className={`absolute inset-0 rounded-full transition-all duration-[2000ms] ease-out ${
        ...
        {/* 太极主体 */}
        <div
          className={`relative w-28 h-28 md:w-36 md:h-36 transition-all duration-[1500ms] ease-out ${
      ...
      {/* 标题 */}
      <h1
        className={`text-4xl md:text-6xl font-serif font-bold text-gold-gradient mb-4 transition-all duration-[1800ms] ease-out ${
      ...
      {/* 分隔线 */}
      <div
        className={`h-px mb-4 bg-gradient-to-r from-transparent via-gold/30 to-transparent transition-all duration-[1200ms] ease-out ${
      ...
      {/* 副标题 */}
      <p
        className={`text-sm md:text-base text-[#a09880] tracking-[0.3em] font-light transition-all duration-[1200ms] ease-out ${
